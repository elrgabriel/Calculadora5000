...
public class One extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btmext = view.findViewById(R.id.bt_next_um);
        btmext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentTransaction t = getParentFragmentManager().beginTransaction();
                Two two = Two.newInstance("","");
                t.replace(R.id.fragmentContainerView, two);
